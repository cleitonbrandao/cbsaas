...
import { createProductAction, ServiceSchema, updatedServiceAction } from "./action";
...
export function ServiceForm({
    ...
    const formAction = isUpdating ? updatedServiceAction : createProductAction
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            {success === false && message && (
                <Alert variant="destructive">
                    ...
                    <AlertTitle>Save service failed!</AlertTitle>
                    <AlertDescription>
                        <p>{message}</p>
                    </AlertDescription>
                </Alert>
