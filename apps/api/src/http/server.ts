...
import { updatedPackage } from './routes/packages/updated-package';
import { searchProducts } from './routes/searchs/search-products';
...
app.register(updatedPackage);

app.register(searchProducts);
